        ...
        <div className="bg-black responsive_wrapper py-10 mt-40">
            ...
            <div className='flex pt-10  '>
                ...
                <div className='w-2/4 flex justify-between'>
                    <h3 className='text-sm font-regular font-secondary text-grayText'>Copyright © 2022 emote.agency</h3>
                    <div className='flex'>
                        <h3 className='text-sm font-regular font-secondary text-grayText pr-10'>Privacy policy</h3>
                        <h3 className='text-sm font-regular font-secondary text-grayText'>Terms conditions</h3>
                    </div>
                </div>
            </div>
        </div>
